...
```{r echo=FALSE, message=FALSE, dur_plot, warning=FALSE, fig.height=5, fig.width=5, fig.align='left'}
m3_dur_norm %>%
...
```{r, dur_plots, warning=FALSE, message=FALSE, echo=FALSE, fig.height=7, fig.width=10, fig.align='right'}
